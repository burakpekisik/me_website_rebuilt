...
const CommentCreate = ({ theme, onClose, onAdd }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (!formData.title || !formData.text || !formData.customer_name || !formData.customer_id) {
      ...
      <ModalContent theme={theme}>
        ...
        <form onSubmit={handleSubmit}>
          <FormGroup>
            ...
            <Select theme={theme} onChange={handleUserSelect} required>
