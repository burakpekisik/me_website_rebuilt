...
const _nav = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        component: CNavItem,
        name: 'Navbar/Footer Yönetimi',
        to: '/menu_links',
      },
      {
        component: CNavItem,
        name: 'Cezaevi Yönetimi',
        to: '/jail_management',
      },
      {
        component: CNavItem,
        name: 'İl/İlçe Yönetimi',
        to: '/district_city_management',
      },
      {
        component: CNavItem,
        name: 'Kartpostallar',
      ...
      {
        component: CNavItem,
        name: 'Hazır Şablon Yönetimi',
        to: '/schemas',
      },
      {
        component: CNavItem,
        name: 'Zarf Rengi Yönetimi',
        to: '/envelope_color',
      },
      {
        component: CNavItem,
        name: 'Kağıt Rengi Yönetimi',
        to: '/paper_color',
      },
    ],
  },
